...
We observe that `r dim(highcorvar)[1]` pairs have very high correlation, but it is too difficult to pick which ones to eliminate and it wouldn't be that many to eliminate anyway.

So, we are left with `r dim(training)[2]-1` variables with which to build our predictive model.
